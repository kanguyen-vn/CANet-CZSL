...
7. Execute [`generate_data.py`](generate_data.py) to generate `CANet-CZSL/data_dir/vg/metadata_compositional-split-natural.t7` necessary for training the model. This file contains mappings between the images, object labels, and attribute labels for all train, val, and test splits.
